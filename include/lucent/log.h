...
// variable respects lucent::config's prefix, so an app with prefix "MYAPP_" reads
// MYAPP_LUCENT_DEBUG. Output goes to stderr unless LUCENT_LOG_FILE names a file, or a sink is
// installed in code.
//
