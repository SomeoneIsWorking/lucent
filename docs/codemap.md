...
| Android import foreground lifetime | Java lifecycle tested; Android API compiled by consumers | `platforms/android/java/io/github/someoneisworking/lucent/{LucentImportLifetime,LucentImportNotification,LucentImportService}.java` | One main-thread import lifetime starts foreground protection once, updates notifications without service starts, and stops through `Context.stopService`. Titles supply notification wording/channel and register the non-exported dataSync service; import execution and validation remain separate. |
